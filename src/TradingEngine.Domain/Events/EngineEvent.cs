...
public record OrderSubmitted(Guid OrderId, Symbol Symbol, TradeDirection Direction, decimal Lots, Price? LimitPrice, string StrategyId, DateTime OccurredAtUtc, OrderType OrderType = OrderType.Market, Price StopLoss = default, Price? TakeProfit = null) : EngineEvent(OccurredAtUtc);
