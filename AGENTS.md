...
**Created:** 2026-06-18
**Updated:** 2026-07-05 (P2.7 stop orders delivered — P2 fully done)
...
**Next phase: P3.1** — the excursion recorder (tape-only MAE/MFE path capture, opt-in via `RecordExcursions`).
