...
- Name: live-monitor-links.spec.ts >> Tier 1 — SignalR connectivity >> SignalR connects within 8 seconds (existing run monitor)
- Location: tests\e2e\live-monitor-links.spec.ts:19:3
